...
public static class OpcXmlParser
{
	...
	private static ICollection<OpcNode> ExtractInnerNodes(XmlNodeList nodeList, string stringToParserFor)
	{
	...
	public static ICollection<OpcNode> InsertValuesInStruct(this ICollection<OpcNode> varList, byte[] byteResult)
	{
		//Byte decoding index
		int index = 0;
